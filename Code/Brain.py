...
USER = str() #coloque o usuario aqui
SENHA =  str()#coloque a senha aqui
...
def getEscola(): 
    ...
    #numero
    driver.find_element(By.XPATH, '// *[@id="numero"]').send_keys(faker.building_number())
    #bairro
    driver.find_element(By.XPATH, '//*[@id="bairro"]').send_keys(faker.bairro())
    #telefone
    driver.find_element(By.XPATH, '//*[@id="telefone"]').send_keys(faker.phone_number())
    #funcionarios
    driver.find_element(By.XPATH, '//*[@id="quant_funcionarios"]').send_keys(faker.building_number())
    #quantidade de alunos
    driver.find_element(By.XPATH, '//*[@id="quant_alunos"]').send_keys(faker.building_number())
    #salvar informações
    driver.find_element(By.XPATH, '/html/body/div/div[3]/div/div/div[2]/form/div/div[4]/div/input').click()

def getEmpresas(): 
    #entrando no campo de empresas
    driver.find_element(By.XPATH, '/html/body/div/div[2]/div[2]/div[4]/a').click() 
    #adcionar nova empreasa
    driver.find_element(By.XPATH, '/html/body/div/div[3]/div/div[2]/div[1]/div/div[2]/center/a').click() 
    #nome
    driver.find_element(By.XPATH, '//*[@id="razaoSocial"]').send_keys(faker.company())
    #Rua
    driver.find_element(By.XPATH, '//*[@id="rua"]').send_keys(faker.street_name())
    #Cidade da empresa
    ...
    driver.find_element(By.XPATH, '//*[@id="cep"]').send_keys(faker.postcode())
    #telefone_celular
    driver.find_element(By.XPATH, '//*[@id="celular"]').send_keys(faker.phone_number())

    driver.find_element(By.XPATH, '/html/body/div/div[3]/div/div/div[2]/form/div/div[5]/div/input').click()
